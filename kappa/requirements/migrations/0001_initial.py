...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('req_requirement', (
            ...
            ('business_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.create_table('req_requirement_business_rule', (
        ...
        db.create_unique('req_requirement_business_rule', ['requirement_id', 'business_rule_id'])

        # Adding model 'RequirementInput'
        db.create_table('req_requirement_input', (
        ...
        db.create_table('req_requirement_output', (
        ...
        db.create_table('req_acceptance_criteria', (
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('req_requirement_business_rule', ['requirement_id', 'business_rule_id'])

        # Deleting model 'Requirement'
        db.delete_table('req_requirement')

        # Deleting model 'RequirementBusinessRule'
        db.delete_table('req_requirement_business_rule')

        # Deleting model 'RequirementInput'
        db.delete_table('req_requirement_input')

        # Deleting model 'RequirementOutput'
        db.delete_table('req_requirement_output')

        # Deleting model 'AcceptanceCriteria'
        db.delete_table('req_acceptance_criteria')


    models = {
        u'businessrules.businessrule': {
            'Meta': {'object_name': 'BusinessRule', 'db_table': "'br_business_rule'"},
        ...
        u'requirements.acceptancecriteria': {
            'Meta': {'object_name': 'AcceptanceCriteria', 'db_table': "'req_acceptance_criteria'"},
        ...
        u'requirements.requirement': {
            'Meta': {'object_name': 'Requirement', 'db_table': "'req_requirement'"},
            'business_type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'code': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'requirements.requirementbusinessrule': {
            'Meta': {'unique_together': "(('requirement', 'business_rule'),)", 'object_name': 'RequirementBusinessRule', 'db_table': "'req_requirement_business_rule'"},
        ...
        u'requirements.requirementinput': {
            'Meta': {'object_name': 'RequirementInput', 'db_table': "'req_requirement_input'"},
            'requirement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['requirements.Requirement']"}),
        ...
        u'requirements.requirementoutput': {
            'Meta': {'object_name': 'RequirementOutput', 'db_table': "'req_requirement_output'"},
            'requirement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['requirements.Requirement']"}),
