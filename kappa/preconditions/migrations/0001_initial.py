...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pco_pre_condition', (
        ...
        db.create_table('pco_pre_condition_requirement', (
        ...
        db.create_unique('pco_pre_condition_requirement', ['requirement_id', 'precondition_id'])

        # Adding model 'PreconditionDescription'
        db.create_table('pco_pre_condition_description', (
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('pco_pre_condition_requirement', ['requirement_id', 'precondition_id'])

        # Deleting model 'Precondition'
        db.delete_table('pco_pre_condition')

        # Deleting model 'PreconditionRequirement'
        db.delete_table('pco_pre_condition_requirement')

        # Deleting model 'PreconditionDescription'
        db.delete_table('pco_pre_condition_description')


    models = {
        u'preconditions.precondition': {
            'Meta': {'object_name': 'Precondition', 'db_table': "'pco_pre_condition'"},
        ...
        u'preconditions.preconditiondescription': {
            'Meta': {'object_name': 'PreconditionDescription', 'db_table': "'pco_pre_condition_description'"},
        ...
        u'preconditions.preconditionrequirement': {
            'Meta': {'unique_together': "(('requirement', 'precondition'),)", 'object_name': 'PreconditionRequirement', 'db_table': "'pco_pre_condition_requirement'"},
            'precondition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['preconditions.Precondition']"}),
